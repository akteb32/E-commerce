...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->foreignId('order_id')->constrained()->onDelete('cascade')->index()->name('fk_order_items_order_id');
            $table->foreignId('product_id')->constrained()->onDelete('cascade')->index()->name('fk_order_items_product_id');

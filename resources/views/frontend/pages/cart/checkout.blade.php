            ...
            <div class="col-lg-5">
                        ...
                        <table class="table no-border">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="w-160 mb-5"><a href="shop-product-full.html" class="text-heading">Angie’s
                                                Boomchickapop Sweet </a></h6></span>
                                        <div class="product-rate-cover">
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment-logo d-flex">
                        ...
                        <img src="{{asset(path: 'frontend/assets/imgs/theme/icons/payment-zapper.svg')}}" alt="">
                    </div>

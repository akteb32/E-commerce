        ...
        <div class="form-group card-body">
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter coupon type" name="coupon_type" required>
                </div>
                <div class="form-group">
                    <label>coupon value</label>
                    <input type="text" class="form-control" placeholder="Enter coupon value" name="coupon_value" required>
                </div>
                <div class="form-group">

...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/assets/frontend/assets/imgs/theme/favicon.svg')}}" />
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{asset('public/assets/frontend/assets/css/plugins/animate.min.css')}}" />
    <link rel="stylesheet" href="{{asset('public/assets/frontend/assets/css/main.css?v=5.3')}}" />
</head>
...
<body>
   ...
   <!-- End Header  -->
    ...
    @include('layout.frontend.body.main')
    ...
    @include('layout.frontend.body.footer')
